...
def create_training_datasets():
    train_dataset, validation_dataset = tf.keras.utils.image_dataset_from_directory(TRAIN_DIRECTORY, validation_split=VALIDATION_SPLIT, subset="both", seed=RANDOM_SEED, image_size=IMAGE_SIZE, color_mode="grayscale", batch_size=BATCH_SIZE, label_mode="int")
